...
<head>
  ...
  <meta name="description" content="Sefa Yıldırım - Admin Panel">
  <meta name="author" content="sefayildirim">
  ...
  <link rel="stylesheet" id="css-main" href="{{ asset('backend/css/dashmix.min.css') }}">
        ...
        <div class="content-header bg-white-5">
          ...
          <a class="fw-semibold text-white tracking-wide" href="/">
            <span class="smini-visible">
              S<span class="opacity-75">y</span>
            </span>
            <span class="smini-hidden">
              Sefa<span class="opacity-75">yıldırım</span>
            </span>
          </a>
          <!-- END Logo -->
        ...
        <div class="content-side content-side-full">
          <ul class="nav-main">
            <li class="nav-main-item">
              <a class="nav-main-link{{ request()->is('admin/category') ? ' active' : '' }}" href="admin/category">
      ...
      <div class="content py-0">
        <div class="row fs-sm">
          <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
            Crafted with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="https://github.com/sefayildirim" target="_blank">sefayildirim</a>
          </div>
          <div class="col-sm-6 order-sm-1 text-center text-sm-start">
            <a class="fw-semibold" href="https://github.com/sefayildirim" target="_blank">sefayildirim</a> &copy;
...
<script src="{{ asset('backend') }}/js/dashmix.app.min.js"></script>
